...
import com.hzh.dsw.R.raw;

/**
 * Manages beeps and vibrations for {@link CaptureActivity}.
 */
 public class ServiceBeepManager implements
    MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, Closeable {

  private static final String TAG = ServiceBeepManager.class.getSimpleName();

  private static final float BEEP_VOLUME = 0.10f;
  private static final long VIBRATE_DURATION = 200L;

  private final Service activity;
  private MediaPlayer mediaPlayer;
  private boolean playBeep;
  private boolean vibrate;

  public ServiceBeepManager(Service activity) {
